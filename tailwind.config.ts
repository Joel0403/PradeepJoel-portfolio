	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Football tournament theme colors
				football: {
			...
			backgroundImage: {
				'gradient-field': 'linear-gradient(to right, #243949 0%, #517fa4 100%)',
				'gradient-green': 'linear-gradient(90deg, hsla(139, 70%, 75%, 1) 0%, hsla(63, 90%, 76%, 1) 100%)',
				'gradient-orange': 'linear-gradient(90deg, hsla(22, 100%, 78%, 1) 0%, hsla(2, 78%, 62%, 1) 100%)',
			},
			borderRadius: {
				lg: 'var(--radius)',
